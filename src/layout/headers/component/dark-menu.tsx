...
import DarkNav from "./dark-nav";

type IProps = {
  setDarkMenuOpen: React.Dispatch<React.SetStateAction<boolean>>;
  darkMenuOpen: boolean;
}

export default function DarkMenu({ setDarkMenuOpen, darkMenuOpen }: IProps) {
  return (
