...
export default function HeaderNine() {
  ...
  return (
    <>
      ...
      <header className="nav-header header-layout2 style2">
                  ...
                  <div className="header-button ms-0">
                    ...
                    >
                      <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M9 17C13.4183 17 17 13.4183 17 9C17 4.58172 13.4183 1 9 1C4.58172 1 1 4.58172 1 9C1 13.4183 4.58172 17 9 17Z" stroke="currentColor" strokeWidth="2" strokeLinecap="square" />
                        <path d="M19.0004 19.0004L14.6504 14.6504" stroke="currentColor" strokeWidth="2" strokeLinecap="square" />
                      </svg>
